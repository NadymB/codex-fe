...
export const ERR_CODE = {
  ...
  NOT_ENOUGH_WITHDRAWAL_ACCOUNT_INFORMATION:
    "NOT_ENOUGH_WITHDRAWAL_ACCOUNT_INFORMATION".toLowerCase(),
  ...
  WITHDRAWAL_ACCOUNT_NOT_APPROVED:
    "WITHDRAWAL_ACCOUNT_NOT_APPROVED".toLowerCase(),
};

export enum TRADE_CHART {
...
export const PAIR_CODE = {
  ...
  BTCUSDT: "BTCUSDT",
  GOLD_FUTURES: "GOLD",
  ALUMINIUM_FUTURES: "PEPPERSTONE:ALUMINIUM",
  SILVER_FUTURES: "SILVER",
  SUGAR_FUTURES: "SUGAR",
  COFFEE: "COFFEE",
  COPPER: "HG1!",
  CRUDE_OIL: "CL1!",
  ROUGH_RICE_FUTURES: "ZR1!",
  PLATINUM: "PLATINUM",
};
