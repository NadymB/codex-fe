...
export const KycIntroduceLv1 = ({onClose}:{onClose:VoidFunction}) => {
  return (
    <div className="flex flex-col min-h-screen overflow-auto bg-[#000000]">
      ...
      <div className="flex flex-col  px-4 my-4">
        ...
        <div>
          ...
          <div className="pl-[40px] my-4">
            <li className="text-[#888888]">
              <span>{t("kycPage.guidanceContent")}</span>
            </li>
            <li className="text-[#888888]">
              <span>{t("kycPage.guidanceSubContent")}</span>
            </li>
          </div>
          <img
            className="w-full"
