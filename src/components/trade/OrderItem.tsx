    ...
    <div className="flex flex-col gap-1 p-4 border-b border-[#ffffff1a]">
      <div className="flex gap-1 items-center">
        <div className="text-white text-base">
          {token}<span className="text-[#9ca3af]">/USDT</span>
        </div>
        <div
      ...
      <div className="flex">
        ...
        <div className="flex-1 flex flex-col gap-1">
          <span className="text-sm text-[#888]">
            ...
            {remainingSeconds>0?t("tradePage.trade.expectedProfit"):t("tradePage.trade.profit")}
          </span>
        ...
        {remainingSeconds>0&&
        <div className="flex-1 flex justify-end gap-1 text-[#fff]">
